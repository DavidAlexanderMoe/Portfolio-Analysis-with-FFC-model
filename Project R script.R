...
summary(mod1)
avPlots(mod1, grid=TRUE, ylab="mean returns portfolio", lwd=2, cex=1.2, pch=20, main="", col="blue", col.lines="red")

mod2 <- lm(mean_returns ~ df_beta$rmrf + df_beta$hml)
summary(mod2)
avPlots(mod2, grid=TRUE, ylab="mean returns portfolio", lwd=2, cex=1.2, pch=20, main="", col="blue", col.lines="red")

mod3 <- lm(mean_returns ~ df_beta$rmrf + df_beta$umd)
summary(mod3)
avPlots(mod3, grid=TRUE, ylab="mean returns portfolio", lwd=2, cex=1.2, pch=20, main="", col="blue", col.lines="red")
